...
/*	
	$("#banner li").click(function(){
		...
		$(".box12:eq("+$index+")").show();
		$(".box12:eq("+$index+")").siblings(".box12").hide();
	})*/


			$(function() {
				$(".col").mouseover(function() {
					$(".slideup_info_bg").css("display", "block");
				})
				$(".col").mouseout(function() {
					$(".slideup_info_bg").css("display", "none");
				})
				$(".col2").mouseover(function() {
					$(".slideup_info_bgg").css("display", "block");
				})
				$(".col2").mouseout(function() {
					$(".slideup_info_bgg").css("display", "none");
				})
			...
			$(document).ready(function() {
				...
				$("#banner li:nth-of-type(3)").click(function() {
					$(".box12").css("display", "block");
				});

				$("#banner li:nth-of-type(4)").click(function() {
					$(".box12").css("display", "block");
				});
